...
<ToolboxBitmap(GetType(TextBox_Diferenciado), "White.ico")>
...
Partial Public Class TextBox_Diferenciado
    ...
    <Category("ToolsBox Herramientas"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)>
    ...
    <Category("ToolsBox Herramientas"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)>
    Public Sub SelectText(start As Integer, length As Integer)
