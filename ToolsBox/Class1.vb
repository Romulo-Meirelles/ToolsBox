...
'    ' Events
'    <Category("RJ Code Advance"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)> _
...
'    <Category("RJ Code - Appearance"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)> _
