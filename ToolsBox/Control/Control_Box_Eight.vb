...
<ToolboxBitmap(GetType(Control_Box_Eight_Interrogation), "WhitePurple.ico")>
...
<ToolboxBitmap(GetType(Control_Box_Eight_Close), "WhitePurple.ico")>
<DesignTimeVisible(True)>
...
<ToolboxBitmap(GetType(Control_Box_Eight_Max), "WhitePurple.ico")>
<DesignTimeVisible(True)>
...
<ToolboxBitmap(GetType(Control_Box_Eight_Mini), "WhitePurple.ico")>
<DesignTimeVisible(True)>
...
<ToolboxBitmap(GetType(Control_Box_Eight_Hide), "WhitePurple.ico")>
<DesignTimeVisible(True)>
