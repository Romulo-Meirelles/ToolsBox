...
<ToolboxBitmap(GetType(Control_Wifi_Picture), "WhitePurple.ico")>
...
#End Region
    ...
    Public Overrides Sub PaintHook()
        ...
        If Executer = False Then
            ...
            'PictureBox1
            If _Value <= 0 Then
                Me.PictureBox.Image = My.Resources.Signal_00
            ElseIf _Value = 1 Then
                Me.PictureBox.Image = My.Resources.Signal_01
            ElseIf _Value = 2 Then
                Me.PictureBox.Image = My.Resources.Signal_02
            ElseIf _Value = 3 Then
                Me.PictureBox.Image = My.Resources.Signal_03
            ElseIf _Value = 4 Then
                Me.PictureBox.Image = My.Resources.Signal_04
            ElseIf _Value = 5 Then
                Me.PictureBox.Image = My.Resources.Signal_05
            ElseIf _Value >= 5 Then
                Me.PictureBox.Image = My.Resources.Signal_05
