...
Namespace Utils
    Partial Public Module PrintScreenBlock
        Const WDA_NONE As UInteger = 0
        Const WDA_MONITOR As UInteger = 1

        <DllImport("user32.dll")>
        Private Function SetWindowDisplayAffinity(ByVal hWnd As IntPtr, ByVal dwAffinity As UInteger) As UInteger
        End Function

        Public Function BlockPrintScreen(ByVal Handle As IntPtr) As Boolean
            Try
        ...
        Public Function EnablePrintScreen(ByVal Handle As IntPtr) As Boolean
            Try
