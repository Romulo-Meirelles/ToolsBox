...
<ToolboxBitmap(GetType(ListBox_Gradient), "Black.ico")>
<DesignTimeVisible(True)>
Public Class ListBox_Gradient
    Inherits ListBox
    ...
    Private Sub GradientListBox_Resize(ByVal sender As Object, ByVal e As EventArgs)
        Me.method_0()
    End Sub
    ...
    Private Sub method_0()
        ...
        Dim MyColor_1 As New Color
        Dim MyColor_2 As New Color

        ' For i = 0 To bitmap.Width - 1
        MyColor_1 = ColorTransition.getColorScale(Integer.Parse(Math.Round(CDbl(((CDbl(i) / CDbl(bitmap.Width)) * 100)), 0).ToString), Me.GradientTopLeft, Me.GradientTopRight)
        Dim j As Integer
        'For j = 0 To Bitmap.Height - 1
        MyColor_2 = ColorTransition.getColorScale(Integer.Parse(Math.Round(CDbl(((CDbl(j) / CDbl(bitmap.Height)) * 100)), 0).ToString), Me.GradientBottomLeft, Me.GradientBottomRight)
        'Next j
        'Next i
        ...
        Me.BackColor = Graphicals.AddColor(MyColor_1, MyColor_2)
    End Sub

    Private Sub method_1()
        MyBase.SuspendLayout()
        AddHandler MyBase.Resize, New EventHandler(AddressOf Me.GradientListBox_Resize)
