...
<ToolboxBitmap(GetType(ProgressBar_Radial_2), "WhiteBlue.ico")>
<DesignTimeVisible(True)>
Public Class ProgressBar_Radial_2
    Inherits Control

#Region "Declarations"
    Private _BorderColour As Color = Color.Transparent
    Private _BaseColour As Color = Color.Transparent
    Private _ProgressColour As Color = Color.FromArgb(153, 153, 153)
    Private _TextColour As Color = Color.Transparent
    Private _Value As Decimal = 60
    Private _Maximum As Decimal = 60
    Private _StartingAngle As Integer = 275
    Private _RotationAngle As Integer = 360
    Private _Font As Font = New Font("Segoe UI", 3)
#End Region
