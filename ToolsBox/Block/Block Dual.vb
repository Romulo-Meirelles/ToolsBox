...
<ToolboxBitmap(GetType(BlockDualGauge), "Orange.ico")>
<DesignTimeVisible(True)>
Public Class BlockDualGauge
    Inherits Control
    ...
    Private _Cubes As BindingList(Of GaugeCubeItem)
    ...
    '    End Get
    'End Property
    <Category("Block Gauge"),
 DesignerSerializationVisibility(DesignerSerializationVisibility.Content)>
    Public ReadOnly Property Cubes As BindingList(Of GaugeCubeItem)
        Get
            Return _Cubes
        End Get
    End Property
    ...
    Public Property CubeBackDepth As Integer
        ...
        End Set
    End Property
    <Category("Block Gauge"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)>
    ...
    Public Sub New()
        ...
        _Cubes = New BindingList(Of GaugeCubeItem)
        AddHandler _Cubes.ListChanged, Sub()
                                           Invalidate()
                                       End Sub
    End Sub
    ...
    Protected Overrides Sub OnCreateControl()
        ...
        If _Cubes.Count = 0 Then
            If IsInDesignMode() Then
                ...
                .Icon = My.Resources.bitcoin_16px
            })
                ...
                Select Case _CubeDirection
                    Case CubeDirection.RightBottom
                        ...
                        If _ShowBottomText AndAlso Not String.IsNullOrEmpty(cube.BottomText) Then
                            ...
                            If cube.Icon IsNot Nothing Then
                                g.DrawImage(cube.Icon,
                                blockRect.X + (blockRect.Width \ 2) - 8 + CubeBackDepth,
                                yBottom + 30 + CubeBackDepth, 16, 16)
                            End If

                            Using br As New SolidBrush(cube.BottomTextColor)
                                DrawCenteredText(g, cube.BottomText, Font, br,
                                New Rectangle(blockRect.X + 10 + CubeBackDepth, yBottom + CubeBackDepth, blockRect.Width, 40))
                            End Using
                        End If
                    ...
                    Case CubeDirection.LeftBottom
                        ...
                        If _ShowBottomText AndAlso Not String.IsNullOrEmpty(cube.BottomText) Then
                            ...
                            If cube.Icon IsNot Nothing Then
                                g.DrawImage(cube.Icon,
                                blockRect.X + (blockRect.Width \ 2) - 20 - CubeBackDepth,
                                yBottom + 35 + CubeBackDepth, 16, 16)
                            End If
                    ...
                    Case CubeDirection.Bottom
                        ...
                        If _ShowBottomText AndAlso Not String.IsNullOrEmpty(cube.BottomText) Then
                            ...
                            If cube.Icon IsNot Nothing Then
                                g.DrawImage(cube.Icon,
                                blockRect.X + (blockRect.Width \ 2) - 8,
                                yBottom + 25 + CubeBackDepth, 16, 16)
                            End If

                            Using br As New SolidBrush(cube.BottomTextColor)
                                DrawCenteredText(g, cube.BottomText, Font, br,
                                New Rectangle(blockRect.X, yBottom + CubeBackDepth, blockRect.Width, 35))
                            End Using
                        End If
                End Select
...
Public Class GaugeCubeItem
    Public Property Value As Decimal = 1
