...
Public Class DateTimePicker_
    ...
    Private calendarIcon As Image = My.Resources.Resource.calendarWhite
    ...
    Public Property SkinColor As Color
        ...
        Set(ByVal value As Color)
            ...
            If _skinColor.GetBrightness() >= 0.6F Then
                calendarIcon = My.Resources.Resource.calendarDark
            Else
                calendarIcon = My.Resources.Resource.calendarWhite
            End If
