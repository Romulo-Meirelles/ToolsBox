...
Class ListView_ColorTransition
    Inherits ListView
    ' Events
    ...
    Private Sub method_0()
        Dim num As Integer
        Dim num2 As Integer
        Dim color As Color = ListView_ColorTransition.getColorScale(Me.ProgessValue, Me.Color1, Me.Color2)
    ...
    ' Properties
    <Category("ListView"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)>
