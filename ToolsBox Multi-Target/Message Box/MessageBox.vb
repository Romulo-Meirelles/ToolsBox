    ...
    Protected Friend Function MessageBoxPop(ByVal Title As String, ByVal Text As String, ByVal Position As ScreenMost, Optional ByVal MyImage As PictureBox = Nothing, Optional ByVal BackColor As MyColor = MyColor.NoColor)
        ...
        Select Case _Sound
            ...
            Case SoundPlay.Play01
                Using player As New System.Media.SoundPlayer(My.Resources.Resource.Play01)
                    player.Play()
                End Using

              '  My.Computer.Audio.Play(My.Resources.Resource.Play01, AudioPlayMode.Background)
            Case SoundPlay.Play02
                Using player As New System.Media.SoundPlayer(My.Resources.Resource.Play02)
                    player.Play()
                End Using
            Case SoundPlay.Play03
                Using player As New System.Media.SoundPlayer(My.Resources.Resource.Play03)
                    player.Play()
                End Using
            Case SoundPlay.Play04
                Using player As New System.Media.SoundPlayer(My.Resources.Resource.Play04)
                    player.Play()
                End Using
            Case SoundPlay.Mensseger
                Using player As New System.Media.SoundPlayer(My.Resources.Resource.Mensseger)
                    player.Play()
                End Using
        End Select
