...
Public Class Control_TaskBar_Top
    ...
    Private WithEvents PictureBox1 As New System.Windows.Forms.PictureBox
    Private WithEvents Control_Box_Five1 As New ToolsBox.Control_Box_Five
    Private WithEvents Control_Box_Close As New ToolsBox.Control_Box_Eight_Close
    Private WithEvents Control_Box_Max As New ToolsBox.Control_Box_Eight_Max
    Private WithEvents Control_Box_Mini As New ToolsBox.Control_Box_Eight_Mini
    Private WithEvents Control_Box_Hide As New ToolsBox.Control_Box_Eight_Hide
    Private WithEvents PopupMenu As New ContextMenuStrip()
    Private WithEvents RestaurarMenu As New ToolStripMenuItem("Restaurar")
    Private WithEvents MoverMenu As New ToolStripMenuItem("Mover")
    Private WithEvents TamanhoMenu As New ToolStripMenuItem("Tamanho")
    Private WithEvents MinimizarMenu As New ToolStripMenuItem("Minimizar")
    Private WithEvents MaximizarMenu As New ToolStripMenuItem("Maximizar")
    Private WithEvents FecharMenu As New ToolStripMenuItem("Fechar")
    ...
    <Category("ToolsBox Herramienta"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)> _
    ...
    Public Property TitleFont As Font
        ...
        End Set
    End Property
    Private _Icon As Image = My.Resources.Resource.Icon
    <Category("ToolsBox Herramienta"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)> _
    ...
    Public Property BalloonTipTime As Integer
        ...
        End Set
    End Property
    Private _NotifyIconIcon As Drawing.Icon = New Drawing.Icon(New IO.MemoryStream(My.Resources.Resource.TaskBar_Icon))
    <Category("ToolsBox Herramienta"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)>
    ...
    Public Sub New()
        ...
        RestaurarMenu.Image = My.Resources.Resource.Restaure_
        MinimizarMenu.Image = My.Resources.Resource.Minimize_
        MaximizarMenu.Image = My.Resources.Resource.Maximize_
        FecharMenu.Image = My.Resources.Resource.Close_
    ...
    Protected Overrides Sub OnPaint(ByVal pevent As PaintEventArgs)
        ...
        Me.PictureBox1.ContextMenuStrip = ContextMenuStrip
    ...
    Private Sub PictureBox1_DoubleClick(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles PictureBox1.DoubleClick
        ...
        End If
    End Sub
    Private Sub MouseMove_Control_TaskBar_Top(ByVal sender As Object, ByVal e As EventArgs) Handles Panel1.MouseMove
        Utils.MouseMoveUnick(sender, e, MyBase.FindForm)
    End Sub
