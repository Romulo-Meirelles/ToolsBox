...
#End Region
    ...
    Public Overrides Sub PaintHook()
        ...
        If Executer = False Then
            ...
            'PictureBox1
            If _Value <= 0 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_Simple_Picture_0
            ElseIf _Value = 1 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_Simple_Picture_1
            ElseIf _Value = 2 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_Simple_Picture_2
            ElseIf _Value = 3 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_Simple_Picture_3
            ElseIf _Value = 4 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_Simple_Picture_4
            ElseIf _Value >= 4 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_Simple_Picture_4
