...
Public MustInherit Class MyWifiPictureControl
    Inherits Control
...
End Class
<ToolboxBitmap(GetType(UserControl), "UserControl")> _
Public Class Control_Wifi_Picture
    Inherits MyControl
...
#Region "Public Property"
    ...
    <Category("ThemeControl"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)>
...
#End Region
    ...
    Public Overrides Sub PaintHook()
        ...
        If Executer = False Then
            ...
            'PictureBox1
            If _Value <= 0 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_00
            ElseIf _Value = 1 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_01
            ElseIf _Value = 2 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_02
            ElseIf _Value = 3 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_03
            ElseIf _Value = 4 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_04
            ElseIf _Value = 5 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_05
            ElseIf _Value >= 5 Then
                Me.PictureBox.Image = My.Resources.Resource.Signal_05
