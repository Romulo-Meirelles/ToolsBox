...
Public Class RichTextBox_Tools
    ...
    Private WithEvents TaskBar_Top_Control1 As New ToolsBox.Control_TaskBar_Top
    Private WithEvents Document As RichTextBox
    Private WithEvents openWork As New OpenFileDialog
    Private WithEvents OpenImage As New OpenFileDialog
    Private WithEvents tbNew As New ToolStripButton
    Private WithEvents tbOpen As New ToolStripButton
    Private WithEvents tbSave As New ToolStripButton
    Private WithEvents tbCut As New ToolStripButton
    Private WithEvents tbCopy As New ToolStripButton
    Private WithEvents tbPaste As New ToolStripButton
    Private WithEvents tbUnderline As New ToolStripButton
    Private WithEvents tbStrike As New ToolStripButton
    Private WithEvents tbColor As New ToolStripButton
    Private WithEvents tbBackColor As New ToolStripButton
    Private WithEvents tbImage As New ToolStripButton
    Private WithEvents tbAlignLeft As New ToolStripButton
    Private WithEvents tbAlignCentre As New ToolStripButton
    Private WithEvents tbAlignRight As New ToolStripButton
    Private WithEvents tbZoom As New ToolStripButton
    Private WithEvents tbZoomOut As New ToolStripButton
    Private WithEvents tbItalic As New ToolStripButton
    Private WithEvents ToolStripSeparator6 As New ToolStripSeparator
    Private WithEvents ToolStripSeparator7 As New ToolStripSeparator
    Private WithEvents tbUpper As New ToolStripButton
    Private WithEvents tbLower As New ToolStripButton
    Private WithEvents ToolStripSeparator8 As New ToolStripSeparator
    Private WithEvents ToolStripSeparator9 As New ToolStripSeparator
    Private WithEvents tbSelectSize As New ToolStripComboBox
    Private WithEvents Status As New StatusStrip
    Private WithEvents lblCharCount As New ToolStripStatusLabel
    Private WithEvents ToolStripStatusLabel2 As New ToolStripStatusLabel
    Private WithEvents lblZoom As New ToolStripStatusLabel
    Private WithEvents rcMenu As New ContextMenuStrip
    Private WithEvents UndoToolStripMenuItem As New ToolStripMenuItem
    Private WithEvents RedoToolStripMenuItem As New ToolStripMenuItem
    Private WithEvents CutToolStripMenuItem As New ToolStripMenuItem
    Private WithEvents CopyToolStripMenuItem As New ToolStripMenuItem
    Private WithEvents PasteToolStripMenuItem As New ToolStripMenuItem
    Private WithEvents ColorToolStripMenuItem As New ToolStripMenuItem
    Private WithEvents SelectAllToolStripMenuItem As New ToolStripMenuItem
    Private WithEvents saveWork As New SaveFileDialog
    Private WithEvents tbSelectFont As New ToolStripComboBox
    Private WithEvents tbBold As New ToolStripButton
    Private WithEvents mainMenu As New MenuStrip
    Private WithEvents FileToolStripMenuItem As New ToolStripMenuItem
    Private WithEvents mMNew As New ToolStripMenuItem
    Private WithEvents mMOpen As New ToolStripMenuItem
    Private WithEvents toolStripSeparator As New ToolStripSeparator
    Private WithEvents mMSave As New ToolStripMenuItem
    Private WithEvents toolStripSeparator2 As New ToolStripSeparator
    Private WithEvents mMExit As New ToolStripMenuItem
    Private WithEvents EditToolStripMenuItem As New ToolStripMenuItem
    Private WithEvents mMUndo As New ToolStripMenuItem
    Private WithEvents mMRedo As New ToolStripMenuItem
    Private WithEvents toolStripSeparator3 As New ToolStripSeparator
    Private WithEvents mMCut As New ToolStripMenuItem
    Private WithEvents mMCopy As New ToolStripMenuItem
    Private WithEvents mMPaste As New ToolStripMenuItem
    Private WithEvents toolStripSeparator4 As New ToolStripSeparator
    Private WithEvents mMSelectAll As New ToolStripMenuItem
    Private WithEvents mMColor As New ToolStripMenuItem
    Private WithEvents ToolsToolStripMenuItem As New ToolStripMenuItem
    Private WithEvents mMCustomize As New ToolStripMenuItem
    Private WithEvents toolStripSeparator5 As New ToolStripSeparator
    Private WithEvents Tools As New ToolStrip
    Private WithEvents toolStripSeparator1 As New ToolStripSeparator
    ...
    <Category("ToolsBox Herramienta"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)>
    Public Shadows Property ContextMenuStrip() As Boolean
        Get
            Return _rcMenu_
        End Get
        Set(value As Boolean)
    ...
    End Sub
    Private Protected Shadows Sub Show()
        ...
        '
        Me.UndoToolStripMenuItem.Image = My.Resources.Resource.undo_16px
        ...
        '
        Me.RedoToolStripMenuItem.Image = My.Resources.Resource.redo_16px
        ...
        '
        Me.CutToolStripMenuItem.Image = My.Resources.Resource.mMCut_Image
        ...
        '
        Me.CopyToolStripMenuItem.Image = My.Resources.Resource.mMCopy_Image
        ...
        '
        Me.PasteToolStripMenuItem.Image = My.Resources.Resource.mMPaste_Image
        ...
        'PasteToolStripMenuItem
        '
        Me.ColorToolStripMenuItem.Image = My.Resources.Resource.Color
        ...
        '
        Me.SelectAllToolStripMenuItem.Image = My.Resources.Resource.SelectAll
        ...
        'mMExit
        '
        Me.mMExit.Image = My.Resources.Resource._Exit
        ...
        'mMUndo
        '
        Me.mMUndo.Image = My.Resources.Resource.undo_16px
        ...
        'mMRedo
        '
        Me.mMRedo.Image = My.Resources.Resource.redo_16px
        ...
        '
        '
        Me.mMColor.Image = My.Resources.Resource.Color 'Me.mMNew.Image = CType(resources.GetObject("mMNew.Image"), System.Drawing.Image)
        ...
        'mMSelectAll
        '
        Me.mMSelectAll.Image = My.Resources.Resource.SelectAll
        ...
        'mMCustomize
        '
        Me.mMCustomize.Image = My.Resources.Resource.Customize
        ...
        'mMNew
        '
        Me.mMNew.Image = My.Resources.Resource.mMNew_Image 'Me.mMNew.Image = CType(resources.GetObject("mMNew.Image"), System.Drawing.Image)
        ...
        ''mMOpen
        '
        Me.mMOpen.Image = My.Resources.Resource.mMOpen_Image 'CType(resources.GetObject("mMOpen.Image"), System.Drawing.Image)
        ...
        ''mMSave
        ''
        Me.mMSave.Image = My.Resources.Resource.mMSave_Image 'CType(resources.GetObject("mMSave.Image"), System.Drawing.Image)
        ...
        ''mMCut
        ''
        Me.mMCut.Image = My.Resources.Resource.mMCut_Image 'CType(resources.GetObject("mMCut.Image"), System.Drawing.Image)
        ...
        ''mMCopy
        ''
        Me.mMCopy.Image = My.Resources.Resource.mMCopy_Image 'CType(resources.GetObject("mMCopy.Image"), System.Drawing.Image)
        ...
        ''mMPaste
        ''
        Me.mMPaste.Image = My.Resources.Resource.mMPaste_Image 'CType(resources.GetObject("mMPaste.Image"), System.Drawing.Image)
        ...
        Me.tbNew.Image = My.Resources.Resource.tbNew_Image 'CType(resources.GetObject("tbNew.Image"), System.Drawing.Image)
        ...
        Me.tbOpen.Image = My.Resources.Resource.tbOpen_Image 'CType(resources.GetObject("tbOpen.Image"), System.Drawing.Image)
        ...
        Me.tbSave.Image = My.Resources.Resource.tbSave_Image 'CType(resources.GetObject("tbSave.Image"), System.Drawing.Image)
        ...
        Me.tbCut.Image = My.Resources.Resource.tbCut_Image 'CType(resources.GetObject("tbCut.Image"), System.Drawing.Image)
        ...
        Me.tbCopy.Image = My.Resources.Resource.tbCopy_Image 'CType(resources.GetObject("tbCopy.Image"), System.Drawing.Image)
        ...
        Me.tbPaste.Image = My.Resources.Resource.tbPaste_Image 'CType(resources.GetObject("tbPaste.Image"), System.Drawing.Image)
        ...
        Me.tbBackColor.Image = My.Resources.Resource.Pen 'CType(resources.GetObject("tbPaste.Image"), System.Drawing.Image)
        ...
        Me.tbColor.Image = My.Resources.Resource.Color 'CType(resources.GetObject("tbPaste.Image"), System.Drawing.Image)
        ...
        Me.tbImage.Image = My.Resources.Resource.Imagem 'CType(resources.GetObject("tbPaste.Image"), System.Drawing.Image)
        ...
        Me.tbAlignLeft.Image = My.Resources.Resource.Left_Text
        ...
        Me.tbAlignCentre.Image = My.Resources.Resource.Center_Text 'CType(resources.GetObject("tbAlignCentre.Image"), System.Drawing.Image)
        ...
        Me.tbAlignRight.Image = My.Resources.Resource.Right_Text 'CType(resources.GetObject("tbAlignRight.Image"), System.Drawing.Image)
        ...
        Me.tbZoom.Image = My.Resources.Resource.zoom_in 'CType(resources.GetObject("tbZoom.Image"), System.Drawing.Image)
        ...
        Me.tbZoomOut.Image = My.Resources.Resource.zoom_out 'CType(resources.GetObject("tbZoomOut.Image"), System.Drawing.Image)
    ...
    Private Sub tbOpen_Click(sender As System.Object, e As System.EventArgs) Handles tbOpen.Click
        Try
            If openWork.ShowDialog = System.Windows.Forms.DialogResult.OK Then
    ...
    Private Sub tbSave_Click(sender As System.Object, e As System.EventArgs) Handles tbSave.Click
        Try
            If saveWork.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                Try
    ...
    Private Sub tbBackColor_Click(sender As System.Object, e As System.EventArgs) Handles tbBackColor.Click
        Try
            ...
            If ColorPicker.ShowDialog = System.Windows.Forms.DialogResult.OK Then
