...
#Region " Properties "
        ...
        <Category("ThemeContainer"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)>
...
#Region " Property Overrides "
        ...
        <Category("Misc"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)>
        Overrides Property BackColor() As Color
            Get
                Return MyBase.BackColor
            End Get
