...
Class PVTextbox : Inherits ThemedTextbox
    <Category("ThemedTextbox"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)>
...
Public Class NumericUpDown_Dark
    ...
    <Category("NumericUpDown"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)>
