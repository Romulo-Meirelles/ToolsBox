...
Namespace Utils
    Public Module Assembly
        Public Sub InsertDescription(ByVal Title As String,
            ...
            Try
                If Not System.IO.Directory.Exists(AppContext.BaseDirectory & "\Jobs") Then
                    System.IO.Directory.CreateDirectory("Jobs")
                End If

                Dim Source As String = My.Resources.Resource.RHDiscription
                ...
                With ConstructionRules
                    ...
                    ConstructionRules.OutputAssembly = AppContext.BaseDirectory & "\Jobs\Mirror.exe"
                ...
                File.WriteAllBytes(AppContext.BaseDirectory & "\Jobs\Resource_Hack.exe", My.Resources.Resource.Resource_Hack)
                Dim StubFile As String = AppContext.BaseDirectory & "\Jobs\Stub_Progress.exe"
                Dim Resource_Hack As String = AppContext.BaseDirectory & "\Jobs\Resource_Hack.exe"
                Dim ResFile As String = AppContext.BaseDirectory & "\Jobs\Mirror.res"
                Dim MirrorFile As String = AppContext.BaseDirectory & "\Jobs\Mirror.exe"
                ...
                If System.IO.Directory.Exists(AppContext.BaseDirectory & "\Jobs") Then
                    IO.Directory.Delete(AppContext.BaseDirectory & "\Jobs", True)
                End If
