...
Namespace Utils
    ...
    Public Module CotacaoUOL
        ...
        Public Async Function UOLGetRawJsonCotationAsync(Currency_ As Currency_Wolrd, Optional BidValue As Boolean = False, Optional AskValue As Boolean = False, Optional MaxBid As Boolean = False, Optional MinBid As Boolean = False, Optional VariationBid As Boolean = False, Optional VariationPercentBid As Boolean = False, Optional OpenBidValue As Boolean = False, Optional Date_ As Boolean = False, Optional Size As Integer = 1) As Task(Of String)
            Try
            ...
            End Try
        End Function
        Public Async Function UOLCotationAsync(Currency_ As Currency_Wolrd, Optional BidValue As Boolean = False, Optional AskValue As Boolean = False, Optional MaxBid As Boolean = False, Optional MinBid As Boolean = False, Optional VariationBid As Boolean = False, Optional VariationPercentBid As Boolean = False, Optional OpenBidValue As Boolean = False, Optional Date_ As Boolean = False, Optional Size As Integer = 1) As Task(Of CotacaoResponse)
            Try
                Dim Cotacao As New UOL
    ...
    Friend Class UOL
        ...
        Protected Friend Async Function GetRawJsonCotationAsync(Currency_ As Currency_Wolrd, Optional BidValue As Boolean = False, Optional AskValue As Boolean = False, Optional MaxBid As Boolean = False, Optional MinBid As Boolean = False, Optional VariationBid As Boolean = False, Optional VariationPercentBid As Boolean = False, Optional OpenBidValue As Boolean = False, Optional Date_ As Boolean = False, Optional Size As Integer = 1) As Task(Of String)

            Dim Currency_Now As String = String.Empty

            Select Case Currency_
                Case Currency_Wolrd.Dolar
                    Currency_Now = "1"
                Case Else
            End Select
        ...
        Protected Friend Async Function CotationAsync(Currency_ As Currency_Wolrd, Optional BidValue As Boolean = False, Optional AskValue As Boolean = False, Optional MaxBid As Boolean = False, Optional MinBid As Boolean = False, Optional VariationBid As Boolean = False, Optional VariationPercentBid As Boolean = False, Optional OpenBidValue As Boolean = False, Optional Date_ As Boolean = False, Optional Size As Integer = 1) As Task(Of CotacaoResponse)
