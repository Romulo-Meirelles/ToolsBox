            ...
            Select Case ForcarMetodo
                Case Method.AUTOMATICO
                    ...
                    Else 'Chave Telefone
                        ...
                        Dim Numero As Long
                        If Long.TryParse(Chave, numero) Then

                            ' Agora só tem números. Força DDI se faltar
                            If Chave.StartsWith("+") Then
                                ' já tem DDI, só garantir que não adicionaremos de novo
                            ElseIf Chave.Length >= 10 Then
                                ' ex: 21999999999, 21999999999123 → adiciona DDI
                                Chave = "+55" & Chave
                            Else
                                ' Qualquer outro formato → assume telefone inválido ou incompleto
                                ' Aqui você pode lançar erro, ou simplesmente retornar vazio
                                Chave = "InvalidPix"
                            End If

                            ' Limita tamanho máximo do telefone (Pix aceita até 15)
                ...
                Case Method.CELULAR
                    ...
                    If Integer.TryParse(Chave, numero) Then
                        'Chave = Chave.Replace("+", "")
                        If Chave.StartsWith("+") Then
                        ElseIf Chave.Length >= 10 Then
                            Chave = "+55" & Chave
